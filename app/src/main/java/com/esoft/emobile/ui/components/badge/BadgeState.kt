package com.esoft.emobile.ui.components.badge
...
fun rememberBadgeState(
    ...
    @IntRange(from = 0, to = 999) roundedRadiusPercent: Int = 50,
 ...
 */
class BadgeState(
    var maxNumber: Int = 999,
    var circleShapeThreshold: Int = 1,
    @IntRange(from = 0, to = 999) var roundedRadiusPercent: Int = 50, backgroundColor: Color,
